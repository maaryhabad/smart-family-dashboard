    ...
    def handle(self, intent, detalhes, message):
        ...
        if intent == "composto_lista":
            ...
            if merged_items:
                ...
                return "🎉 **Lista de compras limpa!** Removi todos os itens solicitados e a lista de compras ficou vazia."
        ...
        # 2. clear list (manter_itens)
            ...
            if not target_list:
                return "🤖 Não encontrei nenhuma lista de compras ativa nas minhas memórias para atualizar!"
            ...
            if keep_items:
                ...
                return "🎉 **Parabéns!** Todos os itens foram marcados como comprados e a lista de compras foi limpa das minhas memórias! 🛒"
        ...
        # 3. add items (adicionar_itens)
            ...
            if merged_items:
                ...
                if target_list:
                    delete_memory(target_list['id'])
                return "🎉 A lista de compras foi limpa das minhas memórias!"
        ...
        # 4. remove items (remover_itens)
            ...
            items_to_remove = [clean_item_name(i) for i in raw_remove if clean_item_name(i)]
            if not target_list:
                return "🤖 Não encontrei nenhuma lista de compras ativa nas minhas memórias para remover itens!"
            ...
            if remaining_items:
                ...
                delete_memory(target_list['id'])
                return "🎉 **Lista limpa!** Removi todos os itens e limpei a lista de compras das minhas memórias."
